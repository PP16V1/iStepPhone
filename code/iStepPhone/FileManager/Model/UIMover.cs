...
namespace iStepPhone.FileManager.Model
{
    public class UIMover : IExecuteble
    {
        ...
        public UIMover(Kind _kind, UIExplorer _explorer, List<UserDirectoryClass> items, UserDirectoryClass _selected, List<UserDirectoryClass> _ItemsWithSelected)
        {
            kind = _kind;
            explorer = _explorer;
            Items = items;
